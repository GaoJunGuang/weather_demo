...
public class WeatherDB {
    ...
    public void saveCityWeather(CityWeather cityWeather) {
        ...
        if (cityWeather != null) {
            ...
            values.put("airqlty",cityWeather.getAirQlty());
...
//                cityWeather.setIcon(cursor.getString(cursor.getColumnIndex("icon")));
                ...
                cityWeather.setAirQlty(cursor.getString(cursor.getColumnIndex("airqlty")));

                list.add(cityWeather);
                Log.i("sdkdemo",cityWeather.toString());
    ...
    public void deleteTable(){
        sqLiteDatabase.delete("city_weather_table",null,null);
    }
